...
class MultiPlayerBattleQuestionAnswerPage extends StatefulWidget {
  @override
  _MultiPlayerBattleQuestionAnswerPageState createState() => _MultiPlayerBattleQuestionAnswerPageState();
}

class _MultiPlayerBattleQuestionAnswerPageState extends State<MultiPlayerBattleQuestionAnswerPage> {
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      margin: EdgeInsets.only(top: 44,right: 8,left: 8),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Container(
                          margin: EdgeInsets.only(top: 8),
                          child: Text("140 points",style: TextStyle(
                              color: AnimeColor.yellowColor,
                              fontWeight: FontWeight.bold,
                              fontSize: 10
                          ),),
